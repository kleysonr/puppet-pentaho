...
# We don't need the puppet service running periodically
puppet resource service puppet enable=false

# Test it
puppet agent --test

# Enable the agent on the puppet-server
echo
echo "Run the following commands on the puppet-server:"
